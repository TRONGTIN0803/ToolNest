...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: "<p>JSON is easier to debug when it is formatted with indentation and clear nesting.</p><h2>Common uses</h2><p>Use a JSON formatter to read API output, check config files, or minify data for compact storage.</p>",
  ...
  },
  {
    ...
    content: "<p>Word counters are useful when you need to meet a publishing limit or keep writing concise.</p><h2>When to use it</h2><p>Use a word counter before submitting essays, articles, ads, or social posts.</p>",
    author: "ToolNest Team",
  ...
  },
  {
    ...
    content: "<p>Strong passwords are long, random, and unique for each account.</p><h2>What matters most</h2><p>Use at least 16 characters and avoid names, birthdays, or reused phrases.</p>",
    author: "ToolNest Team",
